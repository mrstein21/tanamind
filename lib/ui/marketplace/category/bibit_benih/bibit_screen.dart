...
import 'package:tanamind/ui/marketplace/category/bibit_benih/bibit_view_model.dart';

class BibitScreen extends StatefulWidget {
  @override
  BibitViewScreen createState() => BibitViewScreen();
}

class BibitViewScreen extends BibitViewModel {
  ...
  Widget _buildListItem() {
    return new StaggeredGridView.countBuilder(
        itemCount: listBibit.length,
        primary: false,
        shrinkWrap: true,
        crossAxisCount: 4,
        crossAxisSpacing: 0,
        mainAxisSpacing: 0,
        itemBuilder: (context, index) => _buildCardItem(listBibit[index]),
