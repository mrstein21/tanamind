...
import 'package:tanamind/ui/marketplace/category/tanah/tanah_view_model.dart';

class TanahScreen extends StatefulWidget {
  @override
  TanahViewScreen createState() => TanahViewScreen();
}

class TanahViewScreen extends TanahViewModel {
  ...
  Widget _buildListItem() {
    return new StaggeredGridView.countBuilder(
        ...
        crossAxisSpacing: 0,
        mainAxisSpacing: 0,
        itemBuilder: (context, index) => _buildCardItem(listTanah[index]),
