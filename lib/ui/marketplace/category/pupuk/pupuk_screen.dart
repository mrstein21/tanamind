...
import 'package:tanamind/ui/marketplace/category/pupuk/pupuk_view_model.dart';

class PupukScreen extends StatefulWidget {
  @override
  PupukViewScreen createState() => PupukViewScreen();
}

class PupukViewScreen extends PupukViewModel {
  ...
  Widget _buildListItem() {
    return new StaggeredGridView.countBuilder(
        ...
        crossAxisSpacing: 0,
        mainAxisSpacing: 0,
        itemBuilder: (context, index) => _buildCardItem(listPupuk[index]),
