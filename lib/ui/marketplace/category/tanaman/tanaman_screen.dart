...
import 'package:tanamind/ui/marketplace/category/tanaman/tanaman_view_model.dart';

class TanamanScreen extends StatefulWidget {
  @override
  TanamanViewScreen createState() => TanamanViewScreen();
}

class TanamanViewScreen extends TanamanViewModel {
  ...
  Widget _buildListItem() {
    return new StaggeredGridView.countBuilder(
        ...
        crossAxisSpacing: 0,
        mainAxisSpacing: 0,
        itemBuilder: (context, index) => _buildCardItem(listTanaman[index]),
