...
import 'package:tanamind/ui/marketplace/category/pot/pot_view_model.dart';

class PotScreen extends StatefulWidget {
  @override
  PotViewScreen createState() => PotViewScreen();
}

class PotViewScreen extends PotViewModel {
  int radioValue;
  ...
  Widget _buildListItem() {
    return new StaggeredGridView.countBuilder(
        itemCount: listPot.length,
        primary: false,
        shrinkWrap: true,
        crossAxisCount: 4,
        crossAxisSpacing: 0,
        mainAxisSpacing: 0,
        itemBuilder: (context, index) => _buildCardItem(listPot[index]),
