...
import 'package:tanamind/ui/marketplace/category/lain_lain/etc_view_model.dart';

class EtcScreen extends StatefulWidget {
  @override
  EtcViewScreen createState() => EtcViewScreen();
}

class EtcViewScreen extends EtcViewModel {
            ...
            child: Container(
              ...
              child: TextField(
                decoration: InputDecoration(
                    ...
                    hintText: "Cari Kebutuhan Tanaman",
  ...
  Widget _buildListItem() {
    return new StaggeredGridView.countBuilder(
        itemCount: listEtc.length,
        primary: false,
        shrinkWrap: true,
        crossAxisCount: 4,
        crossAxisSpacing: 0,
        mainAxisSpacing: 0,
        itemBuilder: (context, index) => _buildCardItem(listEtc[index]),
