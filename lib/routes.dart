...
import 'package:tanamind/explore.dart';
...
import 'package:tanamind/ui/marketplace/category/alat/alat_screen.dart';
...
import 'package:tanamind/ui/marketplace/category/tanaman/tanaman_screen.dart';
...
import 'ui/marketplace/category/pot/pot_screen.dart';
...
final Map<String, WidgetBuilder> routes = {
  ...
  /*market category*/
  '/alat_screen': (BuildContext context) => AlatScreen(),
  '/pot_screen': (BuildContext context) => PotScreen(),
  '/bibit_screen': (BuildContext context) => BibitScreen(),
  '/tanaman_screen': (BuildContext context) => TanamanScreen(),
  '/tanah_screen': (BuildContext context) => TanahScreen(),
  '/pupuk_screen': (BuildContext context) => PupukScreen(),
  '/etc_screen': (BuildContext context) => EtcScreen(),
